...
public class RepresentativeAssociationServiceTest
{
    ...
    public void createJudge_null_email() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge(null,"username", "password", 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertEquals("Only RepresentativeAssociation has permissions to this action!", e.getMessage());
    ...
    public void createJudge_null_username() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", null, "password", 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_null_password() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", null, 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_null_id() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", "password", null, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_null_firstName() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", "password", 12345, null, "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_null_lastName() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", "password", 12345, "firstName", null, QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_null_JudgeType() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", "password", 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, null);
        }
        catch (Exception e)
        {
            Assert.assertTrue(e instanceof NullPointerException);
    ...
    public void createJudge_noPermissions() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress2", "username", "password", 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            Assert.assertEquals("Only RepresentativeAssociation has permissions to this action!", e.getMessage());
    ...
    public void createJudge_legal() throws Exception
    {
        ...
        {
            representativeAssociationService.getRepresentativeAssociationController().createRepresentativeAssociation(new RepresentativeAssociation("username/emailAddress", "password", 12345, "firstName", "lastName"));
            representativeAssociationService.createJudge("username/emailAddress", "username", "password", 12345, "firstName", "lastName", QualificationJudge.FOOTBALL, JudgeType.MAJOR_JUDGE);
        }
        catch (Exception e)
        {
            e.printStackTrace();
